...
export class UpdateTokenLength1758794247483 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "emailVerificationToken" character varying(1024)`);
        await queryRunner.query(`COMMENT ON COLUMN "users"."emailVerificationToken" IS '邮箱验证令牌'`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "passwordResetToken" character varying(1024)`);
        await queryRunner.query(`COMMENT ON COLUMN "users"."passwordResetToken" IS '密码重置令牌'`);
