...
export class InitialSchema1760944323057 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_7a46ddf94a4c42ad2f54f08137" ON "user_login_logs" ("userId", "success", "createdAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_d484976a9516925744d741d237" ON "user_login_logs" ("createdAt") `);
        await queryRunner.query(`COMMENT ON TABLE "user_login_logs" IS '用户登录日志表'`);
        ...
        await queryRunner.query(`COMMENT ON TABLE "user_profiles" IS '用户详细资料表'`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_ef767b3bed56bf20659569da1c" ON "user_sessions" ("expiresAt", "isActive") `);
        await queryRunner.query(`CREATE INDEX "IDX_12341ff731c2b108113dfd6479" ON "user_sessions" ("userId", "deviceId") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_cc7b72308d845b05bbf8731813"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_891ab977ad7612f808f27b156c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_efff5b20f93a9c5d05f76dd6af"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_1c4f6111333be8b8397ce99904"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_592c5557f7b0b242cf3af1c5a7"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e17c2e6296461aeb8a73b9de33"`);
        await queryRunner.query(`DROP TABLE "ip_access_logs"`);
        await queryRunner.query(`COMMENT ON TABLE "ip_blacklists" IS NULL`);
        await queryRunner.query(`DROP INDEX "public"."IDX_70d22dff1267ae74ed1311e71f"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e46be9afa8cef003d8e1d0bf8c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_513d840dbbe7cc4e29a16d7b89"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_382176219f3fadae37d699d5e2"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_6b648f15987083aed5ef94feac"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_c45fe537a0978d978807449369"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_cc8a3f097d8ec84137dd156a83"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_311fce37e2e18e8e07a29ad95a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_85d55cbe472951841401de038f"`);
        await queryRunner.query(`DROP TABLE "ip_rate_limits"`);
        await queryRunner.query(`COMMENT ON TABLE "ip_whitelists" IS NULL`);
        await queryRunner.query(`DROP INDEX "public"."IDX_97ef0d818bede3b6d51b6efb40"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e1feff8f27f7506cf2223fe1c2"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_34e87cdc830537269f86ddcb33"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_3bda19533c127a7a66c467e5f4"`);
        await queryRunner.query(`DROP TABLE "captcha_sessions"`);
        await queryRunner.query(`DROP TYPE "public"."captcha_sessions_captchatype_enum"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_12341ff731c2b108113dfd6479"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_ef767b3bed56bf20659569da1c"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_7a46ddf94a4c42ad2f54f08137"`);
