...
```bash
# 在项目根目录运行
pnpm --filter frontend-app-demo build
...
2. 使用 `pnpm --filter frontend-app-demo add <package>` 安装依赖
3. 遵循 KISS 原则，保持代码简洁
4. 所有图片资源需要本地化存储
